...
namespace sym 
{
	...
	std::ostream& Expr::operator<< (std::ostream &out) const { return (out << *expr_); }
	
	bool Expr::operator==(const Expr& other) const { return (*expr_ == *(other.expr_)); }
	
	bool Expr::operator==(const __expr_t& other) const { return (*expr_ == other); }
}                                                                  	
